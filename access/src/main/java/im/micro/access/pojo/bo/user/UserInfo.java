...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.user.UserInfo)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.user.UserInfo other = (im.micro.access.pojo.bo.user.UserInfo) obj;
  ...
  public static im.micro.access.pojo.bo.user.UserInfo parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.user.UserInfo parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.user.UserInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.user.UserInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.user.UserInfo prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.user.UserInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserInfo getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.user.UserInfo.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserInfo build() {
      im.micro.access.pojo.bo.user.UserInfo result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserInfo buildPartial() {
      im.micro.access.pojo.bo.user.UserInfo result = new im.micro.access.pojo.bo.user.UserInfo(this);
      if (idBuilder_ == null) {
        result.id_ = id_;
      } else {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.user.UserInfo) {
        return mergeFrom((im.micro.access.pojo.bo.user.UserInfo)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.user.UserInfo other) {
      if (other == im.micro.access.pojo.bo.user.UserInfo.getDefaultInstance()) return this;
      if (other.hasId()) {
        mergeId(other.getId());
      }
      if (other.hasName()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.user.UserInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.user.UserInfo) e.getUnfinishedMessage();
  ...
  public static im.micro.access.pojo.bo.user.UserInfo getDefaultInstance() {
