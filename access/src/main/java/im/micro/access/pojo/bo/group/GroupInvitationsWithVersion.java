...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groupInvitations_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.GroupInvitation>();
              mutable_bitField0_ |= 0x00000001;
            }
            groupInvitations_.add(
                input.readMessage(im.micro.access.pojo.bo.group.GroupInvitation.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.group.GroupInvitationsWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.group.GroupInvitationsWithVersion other = (im.micro.access.pojo.bo.group.GroupInvitationsWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.group.GroupInvitationsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.group.GroupInvitationsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupInvitationsWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.group.GroupInvitationsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupInvitationsWithVersion build() {
      im.micro.access.pojo.bo.group.GroupInvitationsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupInvitationsWithVersion buildPartial() {
      im.micro.access.pojo.bo.group.GroupInvitationsWithVersion result = new im.micro.access.pojo.bo.group.GroupInvitationsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.group.GroupInvitationsWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.group.GroupInvitationsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.group.GroupInvitationsWithVersion other) {
      if (other == im.micro.access.pojo.bo.group.GroupInvitationsWithVersion.getDefaultInstance()) return this;
      if (groupInvitationsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.group.GroupInvitationsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.group.GroupInvitationsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupInvitationsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groupInvitations_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.GroupInvitation>(groupInvitations_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.group.GroupInvitation, im.micro.access.pojo.bo.group.GroupInvitation.Builder, im.micro.access.pojo.bo.group.GroupInvitationOrBuilder> 
        getGroupInvitationsFieldBuilder() {
      if (groupInvitationsBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.group.GroupInvitationsWithVersion getDefaultInstance() {
