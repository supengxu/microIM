...
public interface TurmsNotificationOrBuilder extends
   ...
   * @return The data.
   */
  im.micro.access.pojo.notification.TurmsNotification.Data getData();
  /**
   * <code>.im.turms.proto.TurmsNotification.Data data = 4;</code>
   */
  im.micro.access.pojo.notification.TurmsNotification.DataOrBuilder getDataOrBuilder();
   ...
   */
  im.micro.access.pojo.request.TurmsRequest getRelayedRequest();
  /**
   * <code>.im.turms.proto.TurmsRequest relayed_request = 5;</code>
   */
  im.micro.access.pojo.request.TurmsRequestOrBuilder getRelayedRequestOrBuilder();
