...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest other = (im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest) obj;
  ...
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseFrom(
  ...
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseFrom(
  ...
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest getDefaultInstanceForType() {
      return im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest build() {
      im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest buildPartial() {
      im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest result = new im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest) {
        return mergeFrom((im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest other) {
      if (other == im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest) e.getUnfinishedMessage();
  ...
  public static im.micro.access.pojo.request.group.blacklist.CreateGroupBlacklistedUserRequest getDefaultInstance() {
