...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userFriendRequests_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserFriendRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            userFriendRequests_.add(
                input.readMessage(im.micro.access.pojo.bo.user.UserFriendRequest.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion other = (im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion build() {
      im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion buildPartial() {
      im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion result = new im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion other) {
      if (other == im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion.getDefaultInstance()) return this;
      if (userFriendRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserFriendRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userFriendRequests_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserFriendRequest>(userFriendRequests_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.user.UserFriendRequest, im.micro.access.pojo.bo.user.UserFriendRequest.Builder, im.micro.access.pojo.bo.user.UserFriendRequestOrBuilder> 
        getUserFriendRequestsFieldBuilder() {
      if (userFriendRequestsBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.user.UserFriendRequestsWithVersion getDefaultInstance() {
