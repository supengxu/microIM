...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groups_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.Group>();
              mutable_bitField0_ |= 0x00000001;
            }
            groups_.add(
                input.readMessage(im.micro.access.pojo.bo.group.Group.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.group.GroupsWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.group.GroupsWithVersion other = (im.micro.access.pojo.bo.group.GroupsWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.group.GroupsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.group.GroupsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.group.GroupsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupsWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.group.GroupsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupsWithVersion build() {
      im.micro.access.pojo.bo.group.GroupsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupsWithVersion buildPartial() {
      im.micro.access.pojo.bo.group.GroupsWithVersion result = new im.micro.access.pojo.bo.group.GroupsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.group.GroupsWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.group.GroupsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.group.GroupsWithVersion other) {
      if (other == im.micro.access.pojo.bo.group.GroupsWithVersion.getDefaultInstance()) return this;
      if (groupsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.group.GroupsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.group.GroupsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groups_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.Group>(groups_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.group.Group, im.micro.access.pojo.bo.group.Group.Builder, im.micro.access.pojo.bo.group.GroupOrBuilder> 
        getGroupsFieldBuilder() {
      if (groupsBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.group.GroupsWithVersion getDefaultInstance() {
