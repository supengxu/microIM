...
/**
 * Protobuf type {@code im.micro.proto.DeleteRelationshipGroupRequest}
 */
public  final class DeleteRelationshipGroupRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:im.micro.proto.DeleteRelationshipGroupRequest)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequestOuterClass.internal_static_im_micro_proto_DeleteRelationshipGroupRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequestOuterClass.internal_static_im_micro_proto_DeleteRelationshipGroupRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest.class, im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest other = (im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest) obj;
  ...
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseFrom(
  ...
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseFrom(
  ...
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:im.micro.proto.DeleteRelationshipGroupRequest)
      im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequestOuterClass.internal_static_im_micro_proto_DeleteRelationshipGroupRequest_descriptor;
    }
    ...
    // Construct using im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest getDefaultInstanceForType() {
      return im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest build() {
      im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest buildPartial() {
      im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest result = new im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest) {
        return mergeFrom((im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest other) {
      if (other == im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest) e.getUnfinishedMessage();
    ...
    // @@protoc_insertion_point(builder_scope:im.micro.proto.DeleteRelationshipGroupRequest)
  }

  // @@protoc_insertion_point(class_scope:im.micro.proto.DeleteRelationshipGroupRequest)
  private static final im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest();
  }

  public static im.micro.access.pojo.request.user.relationship.DeleteRelationshipGroupRequest getDefaultInstance() {
