...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.group.GroupJoinQuestion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.group.GroupJoinQuestion other = (im.micro.access.pojo.bo.group.GroupJoinQuestion) obj;
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.group.GroupJoinQuestion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.group.GroupJoinQuestion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinQuestion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.group.GroupJoinQuestion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinQuestion build() {
      im.micro.access.pojo.bo.group.GroupJoinQuestion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinQuestion buildPartial() {
      im.micro.access.pojo.bo.group.GroupJoinQuestion result = new im.micro.access.pojo.bo.group.GroupJoinQuestion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.group.GroupJoinQuestion) {
        return mergeFrom((im.micro.access.pojo.bo.group.GroupJoinQuestion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.group.GroupJoinQuestion other) {
      if (other == im.micro.access.pojo.bo.group.GroupJoinQuestion.getDefaultInstance()) return this;
      if (other.hasId()) {
        mergeId(other.getId());
      }
      if (other.hasGroupId()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.group.GroupJoinQuestion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.group.GroupJoinQuestion) e.getUnfinishedMessage();
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinQuestion getDefaultInstance() {
