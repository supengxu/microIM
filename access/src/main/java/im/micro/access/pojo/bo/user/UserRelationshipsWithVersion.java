...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userRelationships_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserRelationship>();
              mutable_bitField0_ |= 0x00000001;
            }
            userRelationships_.add(
                input.readMessage(im.micro.access.pojo.bo.user.UserRelationship.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.user.UserRelationshipsWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.user.UserRelationshipsWithVersion other = (im.micro.access.pojo.bo.user.UserRelationshipsWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.user.UserRelationshipsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.user.UserRelationshipsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserRelationshipsWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.user.UserRelationshipsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserRelationshipsWithVersion build() {
      im.micro.access.pojo.bo.user.UserRelationshipsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UserRelationshipsWithVersion buildPartial() {
      im.micro.access.pojo.bo.user.UserRelationshipsWithVersion result = new im.micro.access.pojo.bo.user.UserRelationshipsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.user.UserRelationshipsWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.user.UserRelationshipsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.user.UserRelationshipsWithVersion other) {
      if (other == im.micro.access.pojo.bo.user.UserRelationshipsWithVersion.getDefaultInstance()) return this;
      if (userRelationshipsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.user.UserRelationshipsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.user.UserRelationshipsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserRelationshipsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userRelationships_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserRelationship>(userRelationships_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.user.UserRelationship, im.micro.access.pojo.bo.user.UserRelationship.Builder, im.micro.access.pojo.bo.user.UserRelationshipOrBuilder> 
        getUserRelationshipsFieldBuilder() {
      if (userRelationshipsBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.user.UserRelationshipsWithVersion getDefaultInstance() {
