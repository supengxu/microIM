...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              groupJoinRequests_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.GroupJoinRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            groupJoinRequests_.add(
                input.readMessage(im.micro.access.pojo.bo.group.GroupJoinRequest.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion other = (im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion build() {
      im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion buildPartial() {
      im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion result = new im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion other) {
      if (other == im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion.getDefaultInstance()) return this;
      if (groupJoinRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureGroupJoinRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        groupJoinRequests_ = new java.util.ArrayList<im.micro.access.pojo.bo.group.GroupJoinRequest>(groupJoinRequests_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.group.GroupJoinRequest, im.micro.access.pojo.bo.group.GroupJoinRequest.Builder, im.micro.access.pojo.bo.group.GroupJoinRequestOrBuilder> 
        getGroupJoinRequestsFieldBuilder() {
      if (groupJoinRequestsBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.group.GroupJoinRequestsWithVersion getDefaultInstance() {
