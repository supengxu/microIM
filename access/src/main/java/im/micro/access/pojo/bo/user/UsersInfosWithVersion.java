...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userInfos_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            userInfos_.add(
                input.readMessage(im.micro.access.pojo.bo.user.UserInfo.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.micro.access.pojo.bo.user.UsersInfosWithVersion)) {
      return super.equals(obj);
    }
    im.micro.access.pojo.bo.user.UsersInfosWithVersion other = (im.micro.access.pojo.bo.user.UsersInfosWithVersion) obj;
  ...
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseFrom(
  ...
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.micro.access.pojo.bo.user.UsersInfosWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.micro.access.pojo.bo.user.UsersInfosWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UsersInfosWithVersion getDefaultInstanceForType() {
      return im.micro.access.pojo.bo.user.UsersInfosWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.micro.access.pojo.bo.user.UsersInfosWithVersion build() {
      im.micro.access.pojo.bo.user.UsersInfosWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.micro.access.pojo.bo.user.UsersInfosWithVersion buildPartial() {
      im.micro.access.pojo.bo.user.UsersInfosWithVersion result = new im.micro.access.pojo.bo.user.UsersInfosWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.micro.access.pojo.bo.user.UsersInfosWithVersion) {
        return mergeFrom((im.micro.access.pojo.bo.user.UsersInfosWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.micro.access.pojo.bo.user.UsersInfosWithVersion other) {
      if (other == im.micro.access.pojo.bo.user.UsersInfosWithVersion.getDefaultInstance()) return this;
      if (userInfosBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.micro.access.pojo.bo.user.UsersInfosWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.micro.access.pojo.bo.user.UsersInfosWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserInfosIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userInfos_ = new java.util.ArrayList<im.micro.access.pojo.bo.user.UserInfo>(userInfos_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.micro.access.pojo.bo.user.UserInfo, im.micro.access.pojo.bo.user.UserInfo.Builder, im.micro.access.pojo.bo.user.UserInfoOrBuilder> 
        getUserInfosFieldBuilder() {
      if (userInfosBuilder_ == null) {
  ...
  public static im.micro.access.pojo.bo.user.UsersInfosWithVersion getDefaultInstance() {
